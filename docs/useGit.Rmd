...
# `RMarkdown` and `Knitr`
- A full tutorial can be found [here](www.rmarkdown.rstudio.com/lesson-1.html)
- A useful reference guide can be found [here](www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf).
- A short version of the reference guide can be found [here](www.rmarkdown.rstudio.com/lesson-15.html) or [here](www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf).
