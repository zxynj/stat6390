...
P-value for D3 is 0.118849. Note that some sameples do not have median survival function, so we remove those D3 and adjust the denominator when calculate the p-value.
