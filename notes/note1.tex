...
{\ttfamily\noindent\color{warningcolor}{Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file 'whas100.RData', probable reason 'No such file or directory'}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in strptime(whas100\$foldate, format = "{}\%m/\%d/\%Y"{}): object 'whas100' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(lhs, parent, parent): object 'whas100' not found}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{with}\hlstd{(whas100,} \hlkwd{reSurv}\hlstd{(lenfol, id,} \hlkwd{rep}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{100}\hlstd{), fstat))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in with(whas100, reSurv(lenfol, id, rep(0, 100), fstat)): object 'whas100' not found}}\end{kframe}
\end{knitrout}
  \item One way to plot the event plot with \pkg{reReg} is through \code{plotEvents}
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plotEvents}\hlstd{(}\hlkwd{reSurv}\hlstd{(lenfol, id,} \hlkwd{rep}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{100}\hlstd{), fstat)} \hlopt{~} \hlnum{1}\hlstd{,} \hlkwc{data} \hlstd{= whas100)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plotEvents}\hlstd{(}\hlkwd{reSurv}\hlstd{(lenfol, id,} \hlkwd{rep}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{100}\hlstd{), fstat)} \hlopt{~} \hlstd{bmi2,}
\hlstd{+ }           \hlkwc{data} \hlstd{= whas100} \hlopt{%>%} \hlkwd{mutate}\hlstd{(}\hlkwc{bmi2} \hlstd{=} \hlkwd{factor}\hlstd{(bmi} \hlopt{>} \hlnum{30}\hlstd{,} \hlkwc{labels} \hlstd{=} \hlkwd{c}\hlstd{(}\hlstr{"High BMI"}\hlstd{,} \hlstr{"Normal BMI"}\hlstd{))))}
\end{alltt}
\end{kframe}
\end{knitrout}
\end{itemize}
